	...
	function loading_step() {
		...
		$('#resources-select-wrapper').fadeOut(500, function() {
			$('#processing-wrapper').fadeIn(500, function() {
				...
				setTimeout(function() { 
					$console_message.html("Generating Packets for Credits");	
					$processing_message.html("Generating Packets for Credits");	
					progressBarConsole(38, $('#progressBarConsole'));			
				}, 14000 );
				setTimeout(function() { 
					$console_message.html("Generating <span class='console-message-connected-item'>" + $console_message_resource1_msg + "</span> Credits");
				...
				setTimeout(function() {
					$console_message.html("<span class='console-message-connected-item'>" + $console_message_resource1_msg + "</span> <span class='console-message-success'>Credits Generated Successfully</span>");
				...
				setTimeout(function() { 
					...
					$console_message.html("Generating Packets for COD Points");	
					$processing_message.html("Generating Packets for COD Points");	
					progressBarConsole(58, $('#progressBarConsole'));			
				}, 23000 );
				setTimeout(function() { 
					$('.starting-loading-wrapper').fadeOut(500, function() {
					$console_message.html("Generating <span class='console-message-connected-item'>" + $console_message_resource2_msg + "</span> COD Points");
				...
				setTimeout(function() { 
					$console_message.html("<span class='console-message-connected-item'>" + $console_message_resource2_msg + "</span> <span class='console-message-success'>COD Points Generated Successfully</span>");
        ...
        if (ChatUserName == '') {
            ...
            if (!ChatReplied) {
                setTimeout(function() {
                    ...
                    setTimeout(function() {
                        ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], '<span class="mention">@ ' + ChatUserName + ' &nbsp;</span>  is this your first time here? this is like the only legit Call of Duty Mobile COD Points generator out there');
                        setTimeout(function() {
                            ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], 'guys dont listen to ' + '<span class="mention">@ ' + ChatUserName + ' &nbsp;</span> ' + ' he just wants all Pirate Kings2 for himself haha');
